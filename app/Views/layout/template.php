    ...
    <div class=" wrapper">
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                ...
                <span>Dev : <a href="<?= esc(WA_DEV) ?>" target="blank" rel="nofollow">WINDY NOVIANI</a></span> |
                <span>Versi : <?= esc(APP_VER) ?></span>
            </div>
            <!-- Default to the left -->
            <strong>Copyright &copy; 2023 - <?= date('Y') ?> <a href="<?= base_url() ?>">WINDY STORE</a>.</strong> All rights reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
